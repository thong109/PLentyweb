...
if (!class_exists('\Eccube\Entity\Delivery')) {
    ...
    class Delivery extends \Eccube\Entity\AbstractEntity
    {
        ...
        /** @ORM\OneToMany(targetEntity="Customize\Entity\StoreDelivery", mappedBy="Delivery") */
        ...
        /**
         * @param mixed $StoreDelivery
         */
        public function setStoreDelivery($StoreDelivery): void
        {
