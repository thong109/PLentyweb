...
if (!class_exists('\Eccube\Entity\Product')) {
    ...
    class Product extends \Eccube\Entity\AbstractEntity
    {
        ...
        /**
         * @var \Customize\Entity\ProductSeminar
         *
         * @ORM\OneToMany(targetEntity="\Customize\Entity\ProductSeminar", mappedBy="product", cascade={"remove"})
         */
        private $ProductSeminar;
        ...
        public function __construct()
        {
            ...
            $this->ProductSeminar = new \Doctrine\Common\Collections\ArrayCollection();
        ...
        public function copy()
        {
            ...
            $Schedules = $this->getProductSeminar();
            $this->ProductSeminar = new ArrayCollection();
            foreach ($Schedules as $Schedule) {
                $CloneSchedule = clone $Schedule;
                $this->addProductSeminar($CloneSchedule);
                $CloneSchedule->setProduct($this);
            }
         ...
         * Add productSeminar.
         */
        public function addProductSeminar(ProductSeminar $productSeminar): Product
        {
            $this->ProductSeminar[] = $productSeminar;

            return $this;
        }

        /**
         * Remove productSeminar.
         *
         * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
         */
        public function removeProductSeminar(ProductSeminar $productSeminar): bool
        {
            return $this->ProductSeminar->removeElement($productSeminar);
        }

        /**
         * Get productSeminar.
         */
        public function getProductSeminar(): Collection
        {
            return $this->ProductSeminar;
        }
        ...
        public function getSchedules(): array
        {
            ...
            foreach ($this->getProductSeminar() as $productSeminar) {
                $schedules[] = $productSeminar->getProductSeminar();
            }
