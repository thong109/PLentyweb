...
final class EccubeEvents
{
     ...
     */
    // index
    const FRONT_SEMINAR_INDEX_INITIALIZE = 'front.seminar.index.initialize';
    const FRONT_SEMINAR_INDEX_SEARCH = 'front.seminar.index.search';
    const FRONT_SEMINAR_INDEX_COMPLETE = 'front.seminar.index.complete';
    const FRONT_SEMINAR_INDEX_DISP = 'front.seminar.index.disp';
    const FRONT_SEMINAR_INDEX_ORDER = 'front.seminar.index.order';

    // detail
    const FRONT_SEMINAR_DETAIL_INITIALIZE = 'front.seminar.detail.initialize';
    const FRONT_SEMINAR_DETAIL_FAVORITE = 'front.seminar.detail.favorite';
    const FRONT_SEMINAR_DETAIL_COMPLETE = 'front.seminar.detail.complete';

    const FRONT_SEMINAR_CART_ADD_INITIALIZE = 'front.seminar.cart.add.initialize';
    const FRONT_SEMINAR_CART_ADD_COMPLETE = 'front.seminar.cart.add.complete';

    const FRONT_SEMINAR_FAVORITE_ADD_INITIALIZE = 'front.seminar.favorite.add.initialize';
    const FRONT_SEMINAR_FAVORITE_ADD_COMPLETE = 'front.seminar.favorite.add.complete';
}
