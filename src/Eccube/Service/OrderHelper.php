...
class OrderHelper
{
    ...
    {
        $CartData = $CartItems->getOwner();
        $ProductItemType = $this->orderItemTypeRepository->find(OrderItemType::PRODUCT);
        return array_map(function ($item) use ($ProductItemType, $CartData) {
            $rentalMin = $item->getRentalMinDay();
            /* @var $item CartItem */
            ...
            $OrderItem
                ...
                ->setRentalMinDay((int)$rentalMin = 0 ? null :  (int) $rentalMin);
